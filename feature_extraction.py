...
class DataGenerator(object):
    def __init__(
            self, datagen_mode='train', dataset='cough', ov=1, split=1, db=30, batch_size=32, seq_len=64,
            shuffle=True, nfft=512, classifier_mode='classify01', weakness=0, cnn3d=False, xyz_def_zero=False, extra_name='',
            azi_only=False
    ):
